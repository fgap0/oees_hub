        ...
        <div class="slick-slider">
            ...
            if (have_rows('slider')) :
                while (have_rows('slider')) : the_row(); ?>
                    ...
                    <?php if (wp_is_mobile(); and get_sub_field('slider_obrazek_m');) { ?>
        ...
        <section id="for">
            <div class="container">
                <div class="row">
                    ...
                    <?php if (wp_is_mobile(); and get_field('for_obrazek_m');) { ?>
        ...
        <section id="for3">
            <div class="container">
                <div class="row">
                    ...
                    <?php if (wp_is_mobile(); and get_field('for3_obrazek_m');) { ?>
        ...
        <section id="for2">
            <div class="container">
                <div class="row">
                    ...
                    <?php if (wp_is_mobile(); and get_field('for2_obrazek_m');) { ?>
